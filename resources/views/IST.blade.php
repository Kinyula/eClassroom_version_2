@section('content')
  ...
  @endif
    <div class="card-body bg-white ETE-table w-100 p-5">
      <h2 class="p-5">Information Systems and Technology Staffs</h2>
        ...
        <div class="col-md-0">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('istRoute') }}" class="w-100">
                        @csrf
                        <input type="hidden" value="4" name="role_id">
                        <input type="hidden" value="Information Systems and Technology staff" name="status">
    <div class="row g-2">
  ...
  <div class="col">
  <div class="form-floating">
    <select id="departmentId" type="select" class="form-select @error('departmentId') is-invalid @enderror" name="departmentId" value="{{ old('departmentId') }}" required autocomplete="departmentId" >
