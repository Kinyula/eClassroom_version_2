    ...
    <main id="" class="main table table-responsive bg-white">
        ...
        @endif
            ...
            <div class="d-flex float-end mt-3">
                ...
                <form wire:submit.prevent="importIstStudents()" class="d-flex">
                ...
                <form wire:submit.prevent="exportIstStudents()" class="d-flex">
        ...
        <h2 class="p-3 fs-5">Information Systems and Technology Students</h2>
        <table class="table table-border datatable ">
            ...
            <tbody>
                ...
                @if ($IstStudents->count() > 0)
                @php
                $srNo = 1;
                @endphp

                @foreach ($IstStudents as $student)
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" onclick="confirm('Are you sure you want to delete this student ?') || event.stopImmediatePropagation()" wire:click="deleteCseStudent({{$student->user->id}})" class="border-0"><i class="bi bi-trash text-danger"></i></button>
                    </td>
