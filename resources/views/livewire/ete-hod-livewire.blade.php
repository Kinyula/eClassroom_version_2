                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="news">
                                <div class="post-item clearfix">
                                    ...
                                    @if ($instructorComment->instructor->department_id == '1')
                                    ...
                                    <p> {{$instructorComment->instructor_comment}}
                                        ...
                                        <button class="text-danger border-0 w-100" wire:click="deleteHodComments({{$instructorComment->id}})" onclick="confirm('Are you sure you want to delete this comment ?') || event.stopImmediatePropagation()"><i class="bi bi-trash"></i></button>
                                    </p>

                                    @else
                                    <div role="alert" class="alert alert-danger dismissible fade show">
                                        <strong>No comments available for now</strong>
                                        <button type="button" class="btn btn-close"></button>
                                    </div>
                                    @endif

                                    @endforeach
                                    {{$instructorComments->links()}}
                                </div>
