            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                    ...
                    <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="{{asset('view_materials')}}">
                                <i class="bi bi-book fs-5"></i><span>View ete materials</span>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="{{asset('ETE/make-ete-quiz')}}">
                                <i class="bi bi-pen fs-5"></i><span>Make quiz question</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{asset('ETE/make-ete-quiz-answer-options')}}">
                                <i class="bi bi-pen fs-5"></i><span>Make quiz answer options</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{asset('ETE/mark-ete-quiz-answer-options')}}">
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                                ...
                                <div class="card info-card customers-card">
                                    ...
                                    <div class="filter">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                            ...
                                            <li><a class="dropdown-item fw-bold" href="#">Email : </a></li>
                            ...
                            <div class="col-12">
                                ...
                                @livewire('replies-to-ete-students-livewire')
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="card p-3">
                                    ...
                                    <div id="studentInformation" style="display: block;">
                                        ...
                                        <p><span class="text-danger fw-bold ">Complaint sent : </span>{{$complaint->student_comment}}
                                        ...
                                        <p><span class="text-danger fw-bold">Complaint sent date and time</span> : {{$complaint->created_at->diffForHumans()}}</p>
                                        <strong class="text-success">From</strong>
                                        <p><span class="text-danger fw-bold">Sender's email</span> : {{$complaint->student->email}}</p>
                                        <span class="text-success fw-bold">To</span>
                                        <p><span class="text-danger fw-bold">Receiver's email</span> : {{$complaint->user->email}}</p>
                                        <br>
                                        </p>
                                        @endforeach
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pb-0">
                                ...
                                @livewire('ete-materials-form-livewire')
