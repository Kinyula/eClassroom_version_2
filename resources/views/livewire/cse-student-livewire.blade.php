            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                        <i class="bi bi-book"></i><span>Course subjects</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">

                        <li>
                            <a href="{{ asset('CSE/view-cse-course-subjects') }}">
                                <i class=" fa-solid fa-file fs-5"></i><span>View subjects</span>
                            </a>
                        </li>
                    ...
                    <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="{{ asset('CSE/view-quiz') }}">
                                <i class="bi bi-pencil-square fs-5"></i><span>Take quiz</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ asset('CSE/view-student-scores') }}">
                                <i class="fa-solid fa-file fs-5"></i><span>View quiz scores</span>
                            </a>
                        </li>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ asset('cse-student') }}"> Dashboard</a></li>
                                    ...
                                    <div class="card-body"> <span>| This Year</span></h5>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ps-3">
                                                ...
                                                <h6>Student's name : {{ $students->student->first_name }}
                                                    {{ $students->student->last_name }} </h6>
                            ...
                            <div class="col-12">
                                <div class="card p-3">
                                    ...
                                    <form wire:submit.prevent="complaints">
                                        ...
                                        <textarea name="complaintInput" id="" cols="15" rows="0" class="form-control"
                                            placeholder="Complaints" wire:model="complaintInput"></textarea>
                                        ...
                                        <select class="form-select" wire:model="complaintInstructor">
                                            <option value="">-- Choose the lecturer to send the complaint to --
                                            </option>

                                            @foreach ($complaintLecturers as $CseLecturers)
                                                <option class="fw-bold" value="{{ $CseLecturers->user_id }}">
                                                    Instructor's full name : {{ $CseLecturers->first_name }}
                                                    {{ $CseLecturers->last_name }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <button type="submit" class="btn btn-sm btn-primary my-4"><i
                                                class="fas fa-paper-plane p-2" wire:loading.attr="disable"></i>Send a
                                            complaint</button>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                            <div class="card-body pb-0">
                                ...
                                @livewire('assignment-uploading-livewire')
                            </div>
                                ...
                                <div class="news">
                                    <div class="post-item clearfix">
                                        ...
                                        @foreach ($instructorReplies as $reply)
                                            <h4> <span class="text-success fw-bold">Instructor's name
                                                    :</span>{{ $reply->instructor->first_name }}
                                                {{ $reply->instructor->last_name }} </h4>
                                            <br>
                                            <h4> <span class="text-success fw-bold">Instructor's reply :</span></h4>
                                            <p> {{ $reply->instructor_reply }} <br>
                                                ...
                                                <button class="text-danger border-0 w-100"
                                                    wire:click="deleteInstructorReplies({{ $reply->id }})"
                                                    onclick="confirm(`Are you sure you want to delete this instructor reply named {{ $reply->instructor->first_name }} {{ $reply->instructor->last_name }}?`) || event.stopImmediatePropagation()"><i
