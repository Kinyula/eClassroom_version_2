<div>
    ...
    <main id="" class="main table table-responsive bg-white">
        ...
        <div class="d-flex float-end mt-3">
            ...
            <form wire:submit.prevent="importEteStaffs()" class="d-flex">
            ...
            <form wire:submit.prevent="exportEteStaffs()" class="d-flex">
        ...
        <h2 class="p-3 fs-5">Electronics and Telecommunications Engineering Staffs</h2>
                    ...
                    @foreach ($EteStaffs as $staff)
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button"
                                    onclick="confirm(`Are you sure you want to delete this staff named {{ $staff->instructor->first_name }} {{ $staff->instructor->last_name }} ?`) || event.stopImmediatePropagation()"
                                    wire:click="deleteCseStaff({{ $staff->id }})" class="border-0"><i
