<div>
    ...
    <main id="" class="main table table-responsive bg-white">
        ...
        <div class="d-flex float-end mt-3">
            ...
            <form wire:submit.prevent="importCseStaffs()" class="d-flex">
    ...
    @endif
        ...
        <h2 class="p-3 fs-5">Computer Science and Engineering Staffs</h2>
                    ...
                    @foreach ($CseStaffs as $staff)
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button"
                                    onclick="confirm(`Are you sure you want to delete this {{ $staff->instructor->first_name }} {{ $staff->instructor->last_name }} as a staff ?`) || event.stopImmediatePropagation()"
