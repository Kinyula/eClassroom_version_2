...
<body>
  ...
  {{-- @dd(auth()->user()->student->department_name) --}}
  @if (auth()->user()->student->department_name == 'ELECTRONICS AND TELECOMMUNICATIONS ENGINEERING DEPARTMENT')

  @livewire('ete-student-livewire')

  @else

  @livewire('cse-student-livewire')
  ...
  @livewire('ist-instructor-livewire')


  @elseif (auth()->user()->role_id == '3')
  @livewire('cse-hod-livewire')

  @elseif (auth()->user()->role_id == '4')
  @livewire('ist-hod-livewire')

  @elseif (auth()->user()->role_id == '2')

  @livewire('ete-hod-livewire')
