...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="fas fa-tasks"></i><span>Staff management</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{asset('ETE/view-cse-subjects')}}">
  ...
  <div class="pagetitle">
      <h1>Dashboard</h1>
      <h6>Date of today : <span class="fw-bold">{{\Carbon\Carbon::now()}}</span></h6>
      <nav>
        <ol class="breadcrumb">
