...
<head>
  ...
  <title>IST | Admin | Dashboard</title>
      ...
      <div class="row">
        ...
        <div class="col-xxl-4 col-xl-12">
          ...
          <div class="card info-card customers-card">
            ...
            <div class="card-body">Information Systems and Technology (IST) Staffs total <span>| This Year</span></h5>
        ...
        <div class="card-body pb-0">
          ...
          <div class="news">
            ...
            @foreach ($instructorComments as $instructorComment)
              <img src="" alt="">
              <h4>{{$instructorComment->last_name}}</h4>

              @foreach ($instructorComment->comment as $comment)
              <p>{{$comment->instructor_comment}}</p> 
              @endforeach
