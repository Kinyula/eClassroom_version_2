...
class AddEteSubjectsLivewire extends Component
{
    public $departments, $subjectName, $subjectCode, $Semester;
    public function render()
    {
        return view('livewire.add-ete-subjects-livewire', ['Semesters' => Semester::get(), 'Departments' => Department::where('id', '1')->get()]);
    }
