...
class IstMaterialsFormLivewire extends Component
{
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        return view('livewire.ist-materials-form-livewire' , ['Years'=>Year::get(), 'Departments'=>Department::where('id', '3')->get()]);
    }

    public function changeSemester(){
        if($this->Semester !==""){
            $this->Subjects = Subject::where('semester_id', $this->Semester)->where('department_id', '3')->orWhere('department_id', '2')->get();
        }
    }

    public function materials(){

        $this->validate(['Semester' => 'required',
